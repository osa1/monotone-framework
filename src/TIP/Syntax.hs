...
data Stmt
  ...
  | While Exp Stmt
      -- ^ Loop
  | Call [Exp]
      -- ^ A function call. This statement is generated by interprocedural CFG
      -- generator. Successors will be other functions in the CFG.
      --
      -- `Exp`s are function arguments.
  | Ret Id
      -- ^ A return node. This statement is generated by interprocedural CFG
      -- generator. Predecessors will be other functions in the CFG.
      --
      -- `Id` is bound to return value of the function vall.
  deriving (Show)
...
stmtExps (Call es)    = S.fromList es
stmtExps (Ret _)      = S.empty
